...
/*
 * Soll eigentlich erlauben, einen neuen Eintrag ähnlich dem vorherigen anzulegen. Dafür sollen die
 * Werte des letzten Eintrags (höchste bibid) angezeigt werden, damit nur noch Veränderungen eingefügt werden müssen.
 * Übernahme der Werte klappt irgendwie nicht.
 */
  ...
  $cancelLocation = "../shared/biblio_view.php?bibid=".$bibid;
  $headerWording="New";
