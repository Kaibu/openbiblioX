...
$bibRes = $biblioQ->getMemberBiblio($mbrid);

$checkoutCount = $biblioQ->mainRowCount;
...
if (($checkoutCount > 0) or ($holdCount > 0)) {
    ...
    <center>
        <form name="delbiblioform" method="POST" action="../circ/mbr_view.php?mbrid=<?php echo HURL($mbrid); ?>&amp;reset=Y">
            ...
            <br><br>
            <input type="button" onClick="self.location='../circ/mbr_del.php?mbrid=<?php echo H(addslashes(U($mbrid))); ?>&amp;name=<?php echo H(addslashes(U($mbrName))); ?>'"
