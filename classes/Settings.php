...
class Settings
{
    ...
    var $_libraryHours = "";
    var $_libraryPhone = "";
    var $_gs_libraryHours = "";
    var $_gs_libraryPhone = "";
    var $_libraryUrl = "";
    var $_opacUrl = "";
     ...
     * @return string
     */
    public function getGsLibraryHours()
    {
        return $this->_gs_libraryHours;
    }

    /**
     * @param string $gs_libraryHours
     */
    public function setGsLibraryHours($gs_libraryHours)
    {
        $this->_gs_libraryHours = $gs_libraryHours;
    }

    /**
     * @return string
     */
    public function getGsLibraryPhone()
    {
        return $this->_gs_libraryPhone;
    }

    /**
     * @param string $gs_libraryPhone
     */
    public function setGsLibraryPhone($gs_libraryPhone)
    {
        $this->_gs_libraryPhone = $gs_libraryPhone;
    }
