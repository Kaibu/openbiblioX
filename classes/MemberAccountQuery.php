...
class MemberAccountQuery extends Query
{
     ...
     * @return mysqli_result|bool returns hold record or false, if error occurs
     * @access public
     ****************************************************************************
     */
     ...
     * Executes a query to select account information
     * @param string $mbrid mbrid of member
     * @return float returns balance due
     * @access public
     ****************************************************************************
     */
     ...
     * @return MemberAccountTransaction|bool returns bibliography status history object or false if no more holds to fetch
     * @access public
     ****************************************************************************
     */
    ...
    function delete($mbrid, $tranid = "")
    {
        ...
        return $this->queryDb($sql, $this->_loc->getText("memberAccountQueryErr3"));
    }
