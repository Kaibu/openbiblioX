...
<form name="loginform" method="POST" action="../shared/login.php" style="border: hidden">
    <table class="primary">
        <tr>
                ...
                <table class="primary">
                    <tr>
                        ...
                        <td valign="top" class="noborder">
                            ...
                            <font
                                class="error"><?php if (isset($pageErrors["username"])) echo H($pageErrors["username"]); ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" class="noborder">
                        ...
                        <td valign="top" class="noborder">
                            <input type="password" name="pwd" size="20" maxlength="20" class="form-control"
