...
define("DOMPDF_CHROOT", '/var/www/bibo/mods/pdfPrint/dompdf');
define("DOMPDF_UNICODE_ENABLED", true);
define("DOMPDF_PDF_BACKEND", "auto"); #PDFLib
...
//define("DOMPDF_LOG_OUTPUT_FILE", '/var/www/bibo/mods/pdfPrint/dompdf/lib/log.htm');
define("DOMPDF_ENABLE_HTML5PARSER", true);
//define("DOMPDF_ENABLE_FONTSUBSETTING", true);

// DOMPDF authentication
define("DOMPDF_ADMIN_USERNAME", "shks");
define("DOMPDF_ADMIN_PASSWORD", "Fo!37%.x");
