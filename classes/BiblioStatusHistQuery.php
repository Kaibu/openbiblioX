...
class BiblioStatusHistQuery extends Query {
   ...
   * @return BiblioStatusHist|bool returns bibliography status history object or false if no more holds to fetch
   * @access public
   ****************************************************************************
   */
  ...
  function deleteByMbrid($mbrid) {
    ...
    return $this->queryDb($sql, $this->_loc->getText("biblioStatusHistQueryErr5"));
  }
