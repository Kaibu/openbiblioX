...
$res = $themeQ->execSelect($set->getThemeid());
$theme = $themeQ->fetchTheme($res);
...
define("OBIB_GS_LIBRARY_HOURS", $set->getGsLibraryHours());
define("OBIB_GS_LIBRARY_PHONE", $set->getGsLibraryPhone());
