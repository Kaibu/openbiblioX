...
if (isset($_GET["reset"])) {
    ...
    $postVars["gs_hours"] = $set->getGsLibraryHours();
    $postVars["gs_phone"] = $set->getGsLibraryPhone();
...
<form name="editsettingsform" method="POST" action="../admin/settings_edit.php">
    ...
    <table class="primary">
        ...
        <tr>
            <td nowrap="true" class="primary">
                NP <?php echo $loc->getText("admin_settingsLibhours"); ?>
            </td>
            <td valign="top" class="primary">
        ...
        <tr>
            <td nowrap="true" class="primary">
                NP <?php echo $loc->getText("admin_settingsLibphone"); ?>
            </td>
            <td valign="top" class="primary">
        ...
        <tr>
            <td nowrap="true" class="primary">
                GS <?php echo $loc->getText("admin_settingsLibhours"); ?>
            </td>
            <td valign="top" class="primary">
                <?php printInputText("gs_hours", 40, 40, $postVars, $pageErrors); ?>
            </td>
        </tr>
        <tr>
            <td nowrap="true" class="primary">
                GS <?php echo $loc->getText("admin_settingsLibphone"); ?>
            </td>
            <td valign="top" class="primary">
                <?php printInputText("gs_phone", 40, 40, $postVars, $pageErrors); ?>
            </td>
        </tr>
        <tr>
            <td nowrap="true" class="primary">
...
<table>
    <tr>
        ...
        <td><font
                class="small"><?php echo $loc->getText("If the month value for purging history is higher than zero, values in statistics reports shift over time.<br>Data from statistics reports should be saved outside OpenBiblio for future reference."); ?>
                <br></font>
        </td>
    </tr>
</table>
